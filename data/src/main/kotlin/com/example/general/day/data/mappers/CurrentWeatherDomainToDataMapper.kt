...
class CurrentWeatherDomainToDataMapper @Inject constructor() :
    Mapper<@JvmSuppressWildcards CurrentWeatherLocalDomain, @JvmSuppressWildcards CurrentWeatherLocalData> {
